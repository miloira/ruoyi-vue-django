  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="手机号码" align="center" key="phone_number" prop="phone_number" v-if="columns[4].visible" width="120" />
          ...
          >
            <template slot-scope="scope" v-if="scope.row.user_id !== 1">
              <el-button
                size="mini"
                type="text"
                icon="el-icon-edit"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="岗位">
              <el-select v-model="form.posts" multiple placeholder="请选择岗位">
                <el-option
    ...
    <el-dialog :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
      <el-upload
        ...
        :action="upload.url + '?update_support=' + upload.updateSupport"
...
<script>
import { listUser, getUser, getUserOptions, delUser, addUser, updateUser, resetUserPwd, changeUserStatus } from "@/api/system/user";
...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data) {
      this.queryParams.dept = data.id.toString();
      this.handleQuery();
    },
    // 用户状态修改
    ...
    handleUpdate(row) {
      ...
      getUser(user_id).then(response => {
        ...
        this.postOptions = response.posts;
        this.roleOptions = response.roles;
        this.form.posts = response.post_ids;
        this.form.roles = response.role_ids;
        this.form.dept = response.data.dept.dept_id;
        this.open = true;
        this.title = "修改用户";
        this.form.password = "";
      });
    ...
    handleAuthRole: function(row) {
      ...
      this.$router.push("/system/user-auth/role/" + user_id);
    },
    /** 提交按钮 */
    submitForm: function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户编号为"' + user_ids + '"的数据项？').then(function() {
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('system/user/import_template/', {
