        ...
        <el-row>
          ...
          <el-col :span="12" v-if="form.menu_type == 'C'">
            <el-form-item prop="component_name">
              <span slot="label">
                <el-tooltip content="keep-alive缓存将根据组件名称进行缓存。" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                组件名称
              </span>
          ...
          <el-col :span="12" v-if="form.menu_type == 'C'">
            <el-form-item>
              <span slot="label">
                <el-tooltip content="将菜单固定在tab" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                是否固定
              </span>
          ...
          <el-col :span="12" v-if="form.menu_type == 'M' || form.menu_type == 'C'">
            <el-form-item>
              <span slot="label">
                <el-tooltip content="在面包屑中显示菜单名称" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                显示面包屑
              </span>
