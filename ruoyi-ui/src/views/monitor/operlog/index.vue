<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="操作类型" align="center" prop="business_type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_oper_type" :value="scope.row.business_type"/>
        </template>
      </el-table-column>
    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="请求地址：">{{ form.request_url }}</el-form-item>
          ...
          <el-col :span="24">
            <el-form-item label="请求参数：">{{ form.request_param }}</el-form-item>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  data() {
    return {
      ...
      dateRange: [],
      // 默认排序
      defaultSort: {prop: 'opTime', order: 'descending'},
      // 表单参数
      form: {},
      // 查询参数
      queryParams: {
  ...
  methods: {
    ...
    typeFormat(row, column) {
      return this.selectDictLabel(this.dict.type.sys_oper_type, row.business_type);
    },
    /** 搜索按钮操作 */
    handleQuery() {
