<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="登录地址" prop="ip_addr">
        <el-input
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="登录地址" align="center" prop="ip_addr" width="130" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const info_ids = row.info_id || this.ids;
      this.$modal.confirm('是否确认删除访问编号为"' + info_ids + '"的数据项？').then(function() {
